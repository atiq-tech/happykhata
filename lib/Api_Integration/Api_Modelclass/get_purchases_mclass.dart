class GetPurchasesMClass {
  List<Purchasess>? purchasess;

  GetPurchasesMClass({this.purchasess});

  GetPurchasesMClass.fromJson(Map<String, dynamic> json) {
    if (json['purchasess'] != null) {
      purchasess = <Purchasess>[];
      json['purchasess'].forEach((v) {
        purchasess!.add(new Purchasess.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.purchasess != null) {
      data['purchasess'] = this.purchasess!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class Purchasess {
  ...
  Purchasess.fromJson(Map<String, dynamic> json) {
