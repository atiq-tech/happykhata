class GetSaleSummaryMClass {
  ...
  String? totalSaleQty;
  String? totalSaleRate;
  String? totalSaleAmount;

  GetSaleSummaryMClass(
      {this.productSlNo,
      this.productCode,
      this.productName,
  ...
  GetSaleSummaryMClass.fromJson(Map<String, dynamic> json) {
    ...
    totalSaleQty = json['totalSaleQty'];
    totalSaleRate = json['totalSaleRate'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['totalSaleQty'] = this.totalSaleQty;
    data['totalSaleRate'] = this.totalSaleRate;
