class SalseRecordModelClass {
  ...
  List<SaleDetails>? _saleDetails;

  SalseRecordModelClass(
  ...
  set totalProducts(String? totalProducts) => _totalProducts = totalProducts;
  List<SaleDetails>? get saleDetails => _saleDetails;
  set saleDetails(List<SaleDetails>? saleDetails) => _saleDetails = saleDetails;

  SalseRecordModelClass.fromJson(Map<String, dynamic> json) {
    ...
    if (json['saleDetails'] != null) {
      ...
      json['saleDetails'].forEach((v) {
        _saleDetails!.add(new SaleDetails.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._saleDetails != null) {
      data['saleDetails'] = this._saleDetails!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class SaleDetails {
  String? _saleDetailsSlNo;
  String? _saleMasterIDNo;
  String? _productIDNo;
  String? _saleDetailsTotalQuantity;
  String? _purchaseRate;
  String? _saleDetailsRate;
  String? _saleDetailsDiscount;
  String? _discountAmount;
  String? _saleDetailsTax;
  String? _saleDetailsTotalAmount;
  String? _status;
  String? _addBy;
  String? _addTime;
  String? _updateBy;
  String? _updateTime;
  String? _saleDetailsBranchId;
  String? _productName;
  ...
  SaleDetails(
    ...
    if (saleDetailsSlNo != null) {
      this._saleDetailsSlNo = saleDetailsSlNo;
    }
    if (saleMasterIDNo != null) {
      this._saleMasterIDNo = saleMasterIDNo;
    }
    if (productIDNo != null) {
      this._productIDNo = productIDNo;
    }
    if (saleDetailsTotalQuantity != null) {
      this._saleDetailsTotalQuantity = saleDetailsTotalQuantity;
    }
    if (purchaseRate != null) {
      this._purchaseRate = purchaseRate;
    }
    if (saleDetailsRate != null) {
      this._saleDetailsRate = saleDetailsRate;
    }
    if (saleDetailsDiscount != null) {
      this._saleDetailsDiscount = saleDetailsDiscount;
    }
    if (discountAmount != null) {
      this._discountAmount = discountAmount;
    }
    if (saleDetailsTax != null) {
      this._saleDetailsTax = saleDetailsTax;
    }
    if (saleDetailsTotalAmount != null) {
      this._saleDetailsTotalAmount = saleDetailsTotalAmount;
    }
    if (status != null) {
      this._status = status;
    }
    ...
    if (saleDetailsBranchId != null) {
      this._saleDetailsBranchId = saleDetailsBranchId;
    }
    if (productName != null) {
...
//
  String? get saleDetailsSlNo => _saleDetailsSlNo;
  set saleDetailsSlNo(String? saleDetailsSlNo) =>
      _saleDetailsSlNo = saleDetailsSlNo;
  String? get saleMasterIDNo => _saleMasterIDNo;
  set saleMasterIDNo(String? saleMasterIDNo) =>
      _saleMasterIDNo = saleMasterIDNo;
  String? get productIDNo => _productIDNo;
  set productIDNo(String? productIDNo) => _productIDNo = productIDNo;
  String? get saleDetailsTotalQuantity => _saleDetailsTotalQuantity;
  set saleDetailsTotalQuantity(String? saleDetailsTotalQuantity) =>
      _saleDetailsTotalQuantity = saleDetailsTotalQuantity;
  String? get purchaseRate => _purchaseRate;
  set purchaseRate(String? purchaseRate) => _purchaseRate = purchaseRate;
  String? get saleDetailsRate => _saleDetailsRate;
  set saleDetailsRate(String? saleDetailsRate) =>
      _saleDetailsRate = saleDetailsRate;
  String? get saleDetailsDiscount => _saleDetailsDiscount;
  set saleDetailsDiscount(String? saleDetailsDiscount) =>
      _saleDetailsDiscount = saleDetailsDiscount;
  String? get discountAmount => _discountAmount;
  set discountAmount(String? discountAmount) =>
      _discountAmount = discountAmount;
  String? get saleDetailsTax => _saleDetailsTax;
  set saleDetailsTax(String? saleDetailsTax) =>
      _saleDetailsTax = saleDetailsTax;
  String? get saleDetailsTotalAmount => _saleDetailsTotalAmount;
  set saleDetailsTotalAmount(String? saleDetailsTotalAmount) =>
      _saleDetailsTotalAmount = saleDetailsTotalAmount;
  String? get status => _status;
  set status(String? status) => _status = status;
  String? get addBy => _addBy;
  set addBy(String? addBy) => _addBy = addBy;
  ...
  String? get updateTime => _updateTime;
  set updateTime(String? updateTime) => _updateTime = updateTime;
  String? get saleDetailsBranchId => _saleDetailsBranchId;
  set saleDetailsBranchId(String? saleDetailsBranchId) =>
      _saleDetailsBranchId = saleDetailsBranchId;
  ...
  SaleDetails.fromJson(Map<String, dynamic> json) {
    _saleDetailsSlNo = json['SaleDetails_SlNo'];
    _saleMasterIDNo = json['SaleMaster_IDNo'];
    _productIDNo = json['Product_IDNo'];
    _saleDetailsTotalQuantity = json['SaleDetails_TotalQuantity'];
    _purchaseRate = json['Purchase_Rate'];
    _saleDetailsRate = json['SaleDetails_Rate'];
    _saleDetailsDiscount = json['SaleDetails_Discount'];
    _discountAmount = json['Discount_amount'];
    _saleDetailsTax = json['SaleDetails_Tax'];
    _saleDetailsTotalAmount = json['SaleDetails_TotalAmount'];
    _status = json['Status'];
    _addBy = json['AddBy'];
    _addTime = json['AddTime'];
    _updateBy = json['UpdateBy'];
    _updateTime = json['UpdateTime'];
    _saleDetailsBranchId = json['SaleDetails_BranchId'];
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['SaleDetails_SlNo'] = this._saleDetailsSlNo;
    data['SaleMaster_IDNo'] = this._saleMasterIDNo;
    data['Product_IDNo'] = this._productIDNo;
    data['SaleDetails_TotalQuantity'] = this._saleDetailsTotalQuantity;
    data['Purchase_Rate'] = this._purchaseRate;
    data['SaleDetails_Rate'] = this._saleDetailsRate;
    data['SaleDetails_Discount'] = this._saleDetailsDiscount;
    data['Discount_amount'] = this._discountAmount;
    data['SaleDetails_Tax'] = this._saleDetailsTax;
    data['SaleDetails_TotalAmount'] = this._saleDetailsTotalAmount;
    data['Status'] = this._status;
    data['AddBy'] = this._addBy;
    data['AddTime'] = this._addTime;
    data['UpdateBy'] = this._updateBy;
    data['UpdateTime'] = this._updateTime;
    data['SaleDetails_BranchId'] = this._saleDetailsBranchId;
